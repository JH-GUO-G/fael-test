...
void LivoxPointsPlugin::OnNewLaserScans() {
    if (rayShape) {
        ...
        scan_point2.header.stamp = scan_point.header.stamp;
        scan_point2.header.frame_id = scan_point.header.frame_id;
        // sensor_msgs::toPCLPointCloud2(scan_point,scan_point2);

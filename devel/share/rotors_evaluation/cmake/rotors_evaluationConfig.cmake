...
if("TRUE" STREQUAL "TRUE")
  set(rotors_evaluation_SOURCE_PREFIX /home/gjh/uav-ugv/fuel/fuel/src/FUEL/rotors_simulator/rotors_evaluation)
  set(rotors_evaluation_DEVEL_PREFIX /home/gjh/uav-ugv/fuel/fuel/devel)
  ...
  set(rotors_evaluation_INSTALL_PREFIX /home/gjh/uav-ugv/fuel/fuel/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gjh/uav-ugv/fuel/fuel/src/FUEL/rotors_simulator/rotors_evaluation/${idir}'.  ${_report}")
    endif()

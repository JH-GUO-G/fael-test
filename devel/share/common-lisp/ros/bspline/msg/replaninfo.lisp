...
;//! \htmlinclude replaninfo.msg.html

(cl:defclass <replaninfo> (roslisp-msg-protocol:ros-message)
  ((duration
    :reader duration
    :initarg :duration
    :type cl:float
...
(cl:defclass replaninfo (<replaninfo>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <replaninfo>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'replaninfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bspline-msg:<replaninfo> is deprecated: use bspline-msg:replaninfo instead.")))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <replaninfo>))
...
(cl:defmethod start_time-val ((m <replaninfo>))
...
(cl:defmethod pos_end-val ((m <replaninfo>))
...
(cl:defmethod pos-val ((m <replaninfo>))
...
(cl:defmethod vel-val ((m <replaninfo>))
...
(cl:defmethod acc-val ((m <replaninfo>))
...
(cl:defmethod start_yaw_-val ((m <replaninfo>))
  ...
  (start_yaw_ m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <replaninfo>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <replaninfo>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<replaninfo>)))
  "Returns string type for a message object of type '<replaninfo>"
  "bspline/replaninfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'replaninfo)))
  "Returns string type for a message object of type 'replaninfo"
  "bspline/replaninfo")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<replaninfo>)))
  "Returns md5sum for a message object of type '<replaninfo>"
  "b0196503bee48a48bdf71c44f3ed61d6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'replaninfo)))
  "Returns md5sum for a message object of type 'replaninfo"
  "b0196503bee48a48bdf71c44f3ed61d6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<replaninfo>)))
  "Returns full string definition for message of type '<replaninfo>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'replaninfo)))
  "Returns full string definition for message of type 'replaninfo"
  (cl:format cl:nil "float64 duration~%time start_time~%geometry_msgs/Vector3 pos_end~%geometry_msgs/Vector3 pos~%geometry_msgs/Vector3 vel~%geometry_msgs/Vector3 acc~%geometry_msgs/Vector3 start_yaw_~%~%~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <replaninfo>))
  (cl:+ 0
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <replaninfo>))

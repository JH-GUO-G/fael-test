...
if(NOT "/home/gjh/fuel/fuel/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gjh/fuel/fuel/src/FUEL/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
